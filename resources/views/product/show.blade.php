        ...
        <div class="container px-5 py-24 mx-auto">
            <div class="lg:w-4/5 mx-auto flex flex-wrap">
                ...
                <div class="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
                    ...
                    <h1 class="text-gray-900 text-3xl title-font font-medium mb-1">{{$product->first_name}}</h1>
                    <div class="flex mb-4">
                    ...
                    <div class="flex">
                        <span class="title-font font-medium text-2xl text-gray-900">{{$product->city}}</span>
                        <a href="{{route('product.create')}}"
                            class="flex ml-auto text-white bg-indigo-500 border-0 py-2 px-6 btn btn-primary rounded">Button</a>
                        <button
